//#include "LevenbergPoseGetter.h"
//
//LevenbergPoseGetter::LevenbergPoseGetter(histograms::Object3d *object3d, const glm::mat4 &initial_pose)
//{
//
//}
//
//glm::mat4 LevenbergPoseGetter::getPose(const cv::Mat &frame, int mode)
//{
//    double params[6] = { 0 };
//    int iter_number = 20;
//    int histo_part = 10;
...
//}
//
//glm::mat4 LevenbergPoseGetter::getPose(const cv::Mat &frame)
//{
